...
public class BeachController : ControllerBase
{
    ...
    public async Task<ActionResult<BeachDto>> CreateAsync([FromBody] CreateBeachModel beachModel)
    {
        ...
        var command = new CreateBeach.Command(Guid.Parse(currUserId.Value),beachModel.Name, beachModel.Description, beachModel.RowsCount,
    ...
    public async Task<ActionResult<BeachDto>> GetAllBeaches()
    {
